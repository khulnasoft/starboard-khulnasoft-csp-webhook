...
import (
	...
	khulnasoftv1alpha1 "github.com/khulnasoft/starboard/pkg/generated/clientset/versioned/typed/khulnasoft/v1alpha1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.khulnasoftV1alpha1, err = khulnasoftv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.khulnasoftV1alpha1 = khulnasoftv1alpha1.NewForConfigOrDie(c)
